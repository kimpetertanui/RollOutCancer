...
public class ShowSingleRecordActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://10.42.0.130/eCancer/FilterCancerCenter.php";
    ...
    String NameHolder, LocationHolder, DescriptionHolder;;
    String TempItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LOCATION = (TextView)findViewById(R.id.summary);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected String doInBackground(String... params) {
                ...
                ResultHash.put("CenterID",params[0]);
                ...
                if(FinalJSonObject != null)
                {
                    ...
                    try {
                        ...
                        for(int i=0; i<jsonArray.length(); i++)
                        {
                            ...
                            // Storing Name, Location, desc into Variables.
